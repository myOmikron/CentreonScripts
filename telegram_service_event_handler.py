...
if __name__ == '__main__':
    ...
    parser.add_argument("-sn", "--service-name", action="store", dest="sname", help="Name of the service")
    parser.add_argument("-s", "--state",  action="store", dest="state", help="State of the service")
    parser.add_argument("-a", "--address",  action="store", dest="address", help="Address of the host")
    parser.add_argument("-o", "--output",  action="store", dest="output", help="Output of the service")
