...
def main():
    ...
    parser.add_argument('-S', '--service', required=True, action='store', dest='service', help='Service description')
    ...
    if args.state == 'OK':
        ...
        emoticon = '&#x26a0;;'
    elif args.state == 'CRITICAL':
        emoticon = '&#x1f4a2;'
    elif args.state == 'UNKNOWN':
        emoticon = '&#x2754;'
    else:
        emoticon = ''

    message = '<b>SERVICE ' + args.state + ' ALERT</b> ' + emoticon + '\n\n'
    message += 'Host: ' + args.name + '\n'
    message += 'Service: ' + args.service + '\n'
